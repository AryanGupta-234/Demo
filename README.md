...
### Phase 2 — Retrieval + agents

Hybrid retrieval, similar-change/clone analysis, specialist agents, and shared agent context.

### Phase 3 — Evidence gate

Attachment discovery, PDF/XLSX/email extraction, claim-to-evidence verification, and contradiction detection.
